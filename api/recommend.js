...
- 각 추천 항목의 'evidence'에는 해당 추천을 뒷받침하는 실제 대화 근거를 1~2문장으로 작성하라. 대화 원문에 있는 짧은 표현은 큰따옴표로 직접 인용하고, 그대로 인용하기 어렵다면 '대화에서 ~라고 말씀하신 점'처럼 간접 인용하라.
...
[JSON]
{"name":"구체적 상품명(브랜드/모델 포함)","emoji":"대표 이모지 1개","reason":"이 상품을 고른 핵심 근거 한 줄","price":"예상 가격대(예산 내)","detail":"상세 설명 2~3문장","evidence":"기존 대화 근거를 그대로 유지한 1~2문장","signals":["취향/니즈 키워드 3개"],"store":"판매처 이름","url":"실제 상품 구매 페이지 URL(없으면 빈 문자열)","query":"쇼핑몰 검색용 구체 키워드"}`;
