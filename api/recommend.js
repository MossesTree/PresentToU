...
function buildUserPrompt({ recipientName, recipientInfo, gender, relationship, budgetMin, budgetMax, budgetAny, summary, recent, note }) {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { recipientName, recipientInfo, gender, relationship, budgetMin, budgetMax, budgetAny, conversation, note } = body;
    ...
    const content = await callOpenAI(apiKey, [
      ...
      { role: 'user', content: buildUserPrompt({ recipientName, recipientInfo, gender, relationship, budgetMin, budgetMax, budgetAny, summary, recent, note: convoNote }) },
